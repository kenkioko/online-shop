...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  <!-- Brand Logo -->
  <a href="{{ Auth::user()->can('dashboard.view') ? route('admin.dash') : route('home.index') }}" class="brand-link">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        @can('dashboard.view')
          ...
          @php
            $new_orders = Auth::user()->hasRole('seller')
                ? Auth::user()->shop()->firstOrFail()->getNewOrders(true)
                : 0;
          @endphp
